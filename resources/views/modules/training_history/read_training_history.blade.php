                ...
                <div class="card">
                    ...
                    <div class="card-body p-lg-17">
                        <div style="float: left" class="position-relative mb-17">
                            <h1>View Training History</h1>
                        </div>
                        <div style="text-align: right" class="position-relative align-right mb-17">
                            <a href="javascript:void(0);"
                               onclick="openPopup('{{ url('/') }}/print_training_history/{{$training_history->id}}')"
                               class="btn btn-secondary"><i class="bi bi-printer fs-4 me-2"></i> Print</a>

                            <a href="{{ url('/') }}/email_training_history/{{ $training_history->id }}"
                                    ...
                                    @if(auth()->user()->hasRole('Admin') || auth()->user()->hasRole('Super Admin'))
                                        ...
                                        <div class="d-flex flex-column mb-5">
                                            ...
                                            <input type="date" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{$training_history->training_expiry_date}}" readonly/>
                                        </div>
                                        <!--end::Input group-->
                                    @endif
                                </form>
...
@section('scripts')
    <script>
        jQuery(document).ready(function ($) {
            var $select2_1 = $('#employee_name').select2();

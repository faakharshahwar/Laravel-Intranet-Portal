                ...
                <div class="card">
                    ...
                    <div class="card-body p-lg-17">
                        ...
                        <div class="d-flex flex-column flex-lg-row mb-17">
                            ...
                            @endif
                            <!--begin::Form-->
                                <form action="{{route('update_training_history')}}" enctype="multipart/form-data"
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <select name="employee_name" data-control="select2"
                                                ...
                                                @foreach($users as $user)
                                                    <option
                                                        {{$training_history->employee_name == $user->id ? 'selected' : ''}}
                                    ...
                                    <div class="d-flex flex-column mb-5 fv-row">
                                        ...
                                        <input type="date" class="form-control form-control-solid" placeholder=""
                                               name="assessment_date" value="{{$training_history->assessment_date}}"/>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="d-flex flex-column mb-5 fv-row">
                                        ...
                                        <input type="date" class="form-control form-control-solid" placeholder=""
                                               ...
                                               value="{{$training_history->must_be_completed_by}}"/>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{$training_history->learning_session_title}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                    ...
                                    <div class="d-flex flex-column mb-5">
                                        ...
                                        <input type="text" class="form-control form-control-solid" placeholder=""
                                               name="learning_time"
                                               value="{{$training_history->learning_time}}"/>
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="d-flex flex-column mb-5">
                                        ...
                                        <input type="date" class="form-control form-control-solid" placeholder=""
                                               ...
                                               value="{{$training_history->learning_session_completion_date}}"/>
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="d-flex flex-column mb-5 fv-row">
                                        ...
                                        <input class="form-control form-control-solid" placeholder=""
                                               ...
                                               value="{{$training_history->link_to_learning_module}}"/>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="d-flex flex-column mb-5 fv-row">
                                        ...
                                        <textarea class="form-control form-control-solid" rows="4" name="comments"
                                                  placeholder=""
                                                  spellcheck="false">{{$training_history->comments}}</textarea>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="d-flex flex-column mb-8">
                                        ...
                                        <input type="hidden" name="old_attachment_1"
                                               value="{{$training_history->attachment_1}}">
                                    ...
                                    <div class="d-flex flex-column mb-8">
                                        ...
                                        <input type="hidden" name="old_attachment_2"
                                               value="{{$training_history->attachment_2}}">
                                        <input type="file" class="form-control form-control-solid" placeholder=""
                                               name="attachment_2"/>
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="d-flex flex-column mb-8">
                                        ...
                                        <input type="hidden" name="old_attachment_3"
                                               value="{{$training_history->attachment_3}}">
                                        <input type="file" class="form-control form-control-solid" placeholder=""
                                               name="attachment_3"/>
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    @if(auth()->user()->hasRole('Admin') || auth()->user()->hasRole('Super Admin'))
                                        ...
                                        <!--begin::Input group-->
                                        <div class="d-flex flex-column mb-5">
                                            <label class="fs-6 fw-semibold mb-2">Training Expiry Date (If Applicable)</label>

                                            <input type="date" class="form-control form-control-solid" placeholder=""
                                                   name="training_expiry_date"
                                                   value="{{$training_history->training_expiry_date}}"/>
                                        </div>
                                        <!--end::Input group-->
                                    @endif

                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-module-table-filter="search"
                                       ...
                                       placeholder="Search Training History">
                            </div>
                            <!--end::Search-->
                            <div class="me-3"></div>
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <!--begin::Export-->
                                <a href="{{route('create_bulk_training_history')}}" class="btn btn-light-primary me-3">
                                    ...
                                    <!--end::Svg Icon-->Create Bulk Training
                                </a>
                                <!--end::Export-->

                                @if(auth()->user()->can('create_training_history'))
                                    <!--begin::Add user-->
                                    <a href="{{route('create_training_history')}}" class="btn btn-primary">
                                        ...
                                        <!--end::Svg Icon-->Add Training History
                                    </a>
                                    <!--end::Add user-->
                                @endif
                            </div>
                    ...
                    <div class="card-body py-4">
                        ...
                        <div id="kt_table_users_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                            <div class="table-responsive">
                                <!--begin::Table-->
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_training_module_table">
                                    <thead>
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        <th class="min-w-125px">ID</th>
                                        <th class="min-w-125px">TRR #</th>
                                        <th class="min-w-125px">Employee Name</th>
                                        <th class="min-w-125px">Learning Session Title</th>
                                        <th class="min-w-125px">Learning Session Completion</th>
                                        <th class="min-w-125px">Assessment Date</th>
                                        <th class="min-w-125px">Attachment</th>
                                        <th class="text-end min-w-100px">Actions</th>
                                    </tr>
                                    </thead>
                                    <tbody class="text-gray-600 fw-semibold"></tbody> <!-- DataTables will populate this body -->
                                </table>
    ...
    <div class="modal fade" id="kt_modal_upload" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" action="{{route('import_rars')}}" method="POST"
...
@section('scripts')
    <script>
        $(document).ready(function () {
            ...
            var datatable = $("#kt_training_module_table").DataTable({
                "processing": true,
                "serverSide": true, // Enable server-side processing
                "ajax": {
                    "url": "{{ route('training_history_data') }}", // Define the route to get the data
                    "type": "GET", // Define the request type
                    "data": function(d) {
                        d.site = $('#site').val(); // Send the selected site value with the request
                    }
                },
                "order": [[0, "desc"]], // Keep sorting by the first column (ID)
                "columns": [
                    { "data": "training_id" }, // Use the aliased column name
                    { "data": "trr_id" },
                    { "data": "employee_first_name" }, // Match the alias
                    { "data": "learning_session_title" },
                    { "data": "learning_session_completion_date" },
                    { "data": "assessment_date" },
                    { "data": "attachment_1" },
                    { "data": "actions", "orderable": false } // Disable sorting on the actions column
                ],
                "columnDefs": [
                    {
            ...
            // Trigger DataTable reload when the site dropdown changes
            $('#site').on('change', function() {
                datatable.ajax.reload(); // Reload the DataTable based on the selected site
            });

            // Search filter input
            const filterSearch = document.querySelector('[data-kt-module-table-filter="search"]');
            filterSearch.addEventListener('keyup', function (e) {
                datatable.search(e.target.value).draw(); // Perform search as user types
            });
        });
    </script>

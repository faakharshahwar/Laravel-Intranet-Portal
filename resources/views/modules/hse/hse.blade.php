                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                @if(auth()->user()->can('read_hse'))

                                    <!--begin::Export-->
                                    <a href="{{route('export_hse')}}" class="btn btn-light-primary me-3">
                                ...
                                @if(auth()->user()->can('create_hse'))
                                    <!--begin::Add user-->
                                    <a href="{{route('create_hse')}}" class="btn btn-primary">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_module_table">
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">For Month Starting</th>
                                        <th class="min-w-125px"># of First Aids</th>
                                        <th class="min-w-125px"># of Near Misses</th>
                                        <th class="min-w-125px"># of Safety Violations</th>
                                        <th class="min-w-125px"># of Medical Cases</th>
                                        <th class="min-w-125px"># of Restricted Cases</th>
                                        <th class="min-w-125px"># of Lost Time Cases</th>
                                        <th class="min-w-125px"># of Recordable Cases</th>
                                        <th class="min-w-125px"># of Environmental Issues</th>
                                        <th class="min-w-125px">Comments (If Any)</th>
                                    ...
                                    @foreach($hses as $hse)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$hse->num_of_medical_cases}}</td>
                                            <td>{{$hse->num_of_restricted_cases}}</td>
                                                ...
                                                <div
                                                    ...
                                                    @if(auth()->user()->can('read_hse'))
                                                        <div class="menu-item px-3">
                                                            <a href="read_hse/{{$hse->id}}"
                                                               class="menu-link px-3">View</a>
                                                        </div>
                                                    @endif
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('edit_hse'))
                                                        <div class="menu-item px-3">
                                                            <a href="edit_hse/{{$hse->id}}"
                                                               class="menu-link px-3">Edit</a>
                                                        </div>
                                                    @endif
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('delete_hse'))
                                                        <div class="menu-item px-3">
                                                            <a href="delete_hse/{{$hse->id}}"
    ...
    <div class="modal fade" id="kt_modal_upload" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" action="{{route('import_hse')}}" method="POST"

                    ...
                    <div class="card-body p-lg-17">
                        ...
                        <div class="d-flex flex-column flex-lg-row mb-17">
                            ...
                            <div class="flex-lg-row-fluid me-0 me-lg-20">
                                ...
                                @endif
                                <!--begin::Form-->
                                <form action="{{route('update_hse')}}" enctype="multipart/form-data"
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <input type="date" class="form-control form-control-solid" placeholder=""
                                                   name="for_month_starting" value="{{$hse->for_month_starting}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <select name="site" data-control="select2"
                                                ...
                                                @foreach($siteArr as $site)
                                                    <option
                                                        {{$hse->site == $site ? 'selected' : ''}} value="{{$site}}">{{$site}}</option>
                                                @endforeach
                                            </select>
                                            <!--end::Input-->
                                        </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="num_of_first_aids" value="{{$hse->num_of_first_aids}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="num_of_near_misses" value="{{$hse->num_of_near_misses}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{$hse->num_of_safety_violations}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="num_of_medical_cases" value="{{$hse->num_of_medical_cases}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{$hse->num_of_restricted_cases}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{$hse->num_of_lost_time_cases}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{$hse->num_of_recordable_cases}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="num_of_environmental_issues"
                                                   value="{{$hse->num_of_environmental_issues}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>

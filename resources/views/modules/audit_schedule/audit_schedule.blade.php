                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            @if(auth()->user()->can('create_audit_schedule'))
                                <!--begin::Add record-->
                            ...
                            <!--begin::Export-->
                                <a href="{{route('export_audit_schedule')}}" class="btn btn-light-primary me-3">
                            ...
                            @if(auth()->user()->can('create_audit_schedule'))
                                <!--begin::Add user-->
                                    <a href="{{route('create_audit_schedule')}}" class="btn btn-primary">
                                        ...
                                        <!--end::Svg Icon-->Add Audit Schedule
                                    </a>
                                    <!--end::Add user-->
                                @endif
                            </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_module_table">
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">Audit ID</th>
                                        <th class="min-w-125px">Audit Type</th>
                                        <th class="min-w-125px">Acutal Audit Date</th>
                                        <th class="min-w-125px">Audit Year</th>
                                        <th class="min-w-125px">Status</th>
                                        <th class="min-w-125px">Audit Report</th>
                                    ...
                                    @foreach($audit_schedules as $audit_schedule)
                                        <!--begin::Table row-->

                                        <tr>
                                            <td>{{$audit_schedule->id}}</td>
                                            ...
                                            <td><a target="_blank"
                                                   href="/uploads/audit_schedule/{{$audit_schedule->audit_report}}">{{$audit_schedule->audit_report}}</a>
                                            </td>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div
                                                    ...
                                                    data-kt-menu="true">
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('read_audit_schedule'))
                                                        <div class="menu-item px-3">
                                                            <a href="read_audit_schedule/{{$audit_schedule->id}}"
                                                               class="menu-link px-3">View</a>
                                                        </div>
                                                    @endif
                                                <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('edit_audit_schedule'))
                                                        <div class="menu-item px-3">
                                                            <a href="edit_audit_schedule/{{$audit_schedule->id}}"
                                                               class="menu-link px-3">Edit</a>
                                                        </div>
                                                    @endif
                                                <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('delete_audit_schedule'))
                                                        <div class="menu-item px-3">
                                                            <a href="delete_audit_schedule/{{$audit_schedule->id}}"
    ...
    <div class="modal fade" id="kt_modal_upload" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" action="{{route('import_audit_schedule')}}" method="POST"

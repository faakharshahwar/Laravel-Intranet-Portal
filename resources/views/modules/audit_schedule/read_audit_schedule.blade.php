                ...
                <div class="card">
                    ...
                    <div class="card-body p-lg-17">
                        ...
                        <div style="text-align: right" class="position-relative align-right mb-17">
                            ...
                            <a href="{{ url('/') }}/email_audit_schedule/{{ $audit_schedule->id }}"
                                ...
                                <form action="{{route('update_audit_schedule')}}"
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="start_date"
                                                   value="{{format_date($audit_schedule->start_date)}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--end::Col-->
                                    ...
                                    <div class="d-flex flex-column mb-5 fv-row">
                                        <!--begin::Label-->
                                        <label class="fs-5 fw-semibold mb-2">Dates</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-solid" placeholder=""
                                               name="dates"
                                               value="{{format_date($audit_schedule->dates)}}" readonly/>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->

                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-module-table-filter="search"
                                       class="form-control form-control-solid w-250px ps-14" placeholder="Search CDs">
                            </div>
                            <!--end::Search-->
                            ...
                            <select id="calibration_category" name="calibration_category" data-control="select2"
                                    data-placeholder="Filter by Calibration Category..."
                                    class="form-select form-select-solid">
                                <option value="" disabled selected></option>
                                <option value="All">All</option>
                                @foreach($calibrationCategoryArr as $calibrationCategory)
                                    <option
                                        value="{{ $calibrationCategory }}" {{ $selectedCalibrationCategory == $calibrationCategory ? 'selected' : '' }}>{{ $calibrationCategory }}</option>
                                @endforeach
                            </select>

                            <div class="me-3"></div>

                            <select id="device_status" name="device_status" data-control="select2"
                                    data-placeholder="Filter by Device Status..."
                                    class="form-select form-select-solid">
                                <option value="" disabled selected></option>
                                <option value="All" {{ $selectedDeviceStatus == 'All' ? 'selected' : '' }}>All</option>
                                <option value="Active" {{ $selectedDeviceStatus == 'Active' ? 'selected' : '' }}>Active</option>
                                <option value="Out of Service" {{ $selectedDeviceStatus == 'Out of Service' ? 'selected' : '' }}>Out of Service</option>
                            </select>
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                @if(auth()->user()->can('create_calibrated_devices'))
                                    <!--begin::Add record-->
                                ...
                                <!--begin::Export-->
                                <a href="{{route('export_calibrated_devices')}}" class="btn btn-light-primary me-3">
                                ...
                                @if(auth()->user()->can('create_calibrated_devices'))
                                    <!--begin::Add user-->
                                    <a href="{{route('create_calibrated_devices')}}" class="btn btn-primary">
                                        ...
                                        <!--end::Svg Icon-->Add Calibrated Devices
                                    </a>
                                    <!--end::Add user-->
                                @endif
                            </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_module_table">
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 gs-0">
                                        ...
                                        <th class="min-w-125px">Device Description</th>
                                        <th class="min-w-125px">Manufacturer</th>
                                        <th class="min-w-125px">Location</th>
                                        <th class="min-w-125px">Date Last Calibrated</th>
                                        <th class="min-w-125px">Next Calibration Due Date</th>
                                        {{--                                        <th class="min-w-125px">Calibrated By</th>--}}
                                    ...
                                    @foreach($calibrated_devices as $cds)
                                        <!--begin::Table row-->
                                        <tr>
                                            <td>{{$cds->id}}</td>
                                            <td><a class="me-5" href="read_calibrated_devices/{{$cds->id}}"><i
                                                        class="fa-solid fa-eye"></i></a><a
                                                    href="edit_calibrated_devices/{{$cds->id}}"><i
                                                        class="fa-solid fa-pen-to-square"></i></a></td>
                                            <td>{{$cds->device_id}}</td>
                                            <td>{{$cds->device_description}}</td>
                                            <td>{{$cds->manufacturer}}</td>
                                            <td>{{$cds->location}}</td>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div
                                                    ...
                                                    data-kt-menu="true">
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('read_calibrated_devices'))
                                                        <div class="menu-item px-3">
                                                            <a href="read_calibrated_devices/{{$cds->id}}"
                                                               class="menu-link px-3">View</a>
                                                        </div>
                                                    @endif
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('edit_calibrated_devices'))
                                                        <div class="menu-item px-3">
                                                            <a href="edit_calibrated_devices/{{$cds->id}}"
                                                               class="menu-link px-3">Edit</a>
                                                        </div>
                                                    @endif
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('delete_calibrated_devices'))
                                                        <div class="menu-item px-3">
                                                            <a href="delete_calibrated_devices/{{$cds->id}}"
    ...
    <div class="modal fade" id="kt_modal_upload" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" action="{{route('import_calibrated_devices')}}" method="POST"

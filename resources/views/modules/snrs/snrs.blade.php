...
@section('pageTitle')
    SNRs Supplier Nonconformance Record
@endsection
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-module-table-filter="search"
                                       class="form-control form-control-solid w-250px ps-14" placeholder="Search SNRs">
                            </div>
                            <!--end::Search-->
                        ...
                        <div class="card-toolbar">
                            ...
                            <!--begin::Export-->
                                <a href="{{route('export_snrs')}}" class="btn btn-light-primary me-3">
                            ...
                            @if(auth()->user()->can('create_snrs'))
                                <!--begin::Add user-->
                                    <a href="{{route('create_snrs')}}" class="btn btn-primary">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div
                                                    ...
                                                    data-kt-menu="true">
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('read_snrs'))
                                                        <div class="menu-item px-3">
                                                            <a href="read_snrs/{{$snr->id}}"
                                                               class="menu-link px-3">View</a>
                                                        </div>
                                                    @endif
                                                <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('edit_snrs'))
                                                        <div class="menu-item px-3">
                                                            <a href="edit_snrs/{{$snr->id}}"
                                                               class="menu-link px-3">Edit</a>
                                                        </div>
                                                    @endif
                                                <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('delete_snrs'))
                                                        <div class="menu-item px-3">
                                                            <a href="delete_snrs/{{$snr->id}}"
    ...
    <div class="modal fade" id="kt_modal_upload" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" action="{{route('import_snrs')}}" method="POST"

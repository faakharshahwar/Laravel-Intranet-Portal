                ...
                <div class="card">
                    ...
                    <div class="card-body p-lg-17">
                        ...
                        <div class="d-flex flex-column flex-lg-row mb-17">
                            ...
                            @endif
                            <!--begin::Form-->
                                <form action="{{route('send_email_customer_feedback_records')}}"
                                    ...
                                    <div class="d-flex flex-column mb-8">
                                        ...
                                        <input type="date" class="form-control form-control-solid" placeholder=""
                                               name="date_originated" value="{{$cfr->date_originated}}" readonly/>
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="row mb-5">
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="date" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{$cfr->target_completion_date}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <!--end::Input-->
                                            <input type="date" class="form-control form-control-solid" placeholder=""
                                                   name="date_completed" value="{{$cfr->date_completed}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="d-flex flex-column mb-8">
                                        ...
                                        <input type="date" class="form-control form-control-solid" placeholder=""
                                               name="date_of_feedback" value="{{$cfr->date_of_feedback}}" readonly/>
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="d-flex flex-column mb-8">
                                        ...
                                        <input type="date" class="form-control form-control-solid" placeholder=""
                                               name="closure_date" value="{{$cfr->closure_date}}" readonly/>
                                    </div>
                                    <!--end::Input group-->

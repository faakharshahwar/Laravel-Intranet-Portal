                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-module-table-filter="search"
                                       class="form-control form-control-solid w-250px ps-14" placeholder="Search CFRs">
                            </div>
                            <!--end::Search-->
                        ...
                        <div class="card-toolbar">
                            ...
                            <!--begin::Export-->
                                <a href="{{route('export_customer_feedback_records')}}"
                            ...
                            @if(auth()->user()->can('create_continual_improvement_records'))
                                <!--begin::Add user-->
                                    <a href="{{route('create_customer_feedback_records')}}" class="btn btn-primary">
                                        ...
                                        <!--end::Svg Icon-->Add Customer Feedback Records
                                    </a>
                                    <!--end::Add user-->
                                @endif
                            </div>
                        ...
                        <div id="kt_table_users_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_module_table">
                                    ...
                                    @foreach($customer_feedback_records as $cfr)
                                        <!--begin::Table row-->
                                        <tr>
                                            <td>{{$cfr->id}}</td>
                                            <td>{{$cfr->cfr_id}}</td>
                                            ...
                                            <td>{{format_date($cfr->date_originated)}}</td>
                                            <td>{{format_date($cfr->closure_date)}}</td>
                                            <!--begin::Action=-->
                                            <td class="text-end">
                                                ...
                                                <div
                                                    ...
                                                    @if(auth()->user()->can('read_continual_improvement_records'))
                                                        <div class="menu-item px-3">
                                                            <a href="read_customer_feedback_records/{{$cfr->id}}"
                                                ...
                                                <!--end::Menu item-->
                                                    ...
                                                    @if(auth()->user()->can('edit_continual_improvement_records'))
                                                        <div class="menu-item px-3">
                                                            <a href="edit_customer_feedback_records/{{$cfr->id}}"
                                                ...
                                                <!--end::Menu item-->
                                                    ...
                                                    @if(auth()->user()->can('delete_continual_improvement_records'))
                                                        <div class="menu-item px-3">
                                                            <a href="delete_customer_feedback_records/{{$cfr->id}}"
    ...
    <div class="modal fade" id="kt_modal_upload" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" action="{{route('import_customer_feedback_records')}}" method="POST"

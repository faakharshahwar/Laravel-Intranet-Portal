                                        ...
                                        <div class="mb-5">
                                            ...
                                            <div id="kt_accordion_2_item_1" class="fs-6 collapse show ps-10"
                                                        ...
                                                        <div data-repeater-list="kt_docs_repeater_basic">
                                                            @foreach ($ecos_items as $ecos_item)
                                                                <div data-repeater-item-db>
                                                                    <input type="hidden" name="eco_item_id"
                                                                           value="{{$ecos_item->id}}">
                                                ...
                                                <div class="row mt-10 mb-10">
                                                    ...
                                                    <div class="col-md-6 fv-row">
                                                        <!--begin::Label-->
                                                        <label class="fs-5 fw-semibold mb-2 required">Reviewed
                                                            By</label>
                                                        <!--end::Label-->
                                                        <!--begin::Input-->
                                                        <select name="reviewed_by" data-control="select2"
                                                            ...
                                                            <option value="" selected disabled></option>
                                                            @foreach($users as $user)
                                                                <option {{$user->id == $user->id ? 'selected' : ''}}
                                                                    value="{{$user->id}}">{{$user->first_name . " " . $user->last_name}}</option>
                                                            @endforeach
                                                        </select>
                                                        <!--end::Input-->
                                                    ...
                                                    <div class="col-md-6 fv-row">
                                                        <!--end::Label-->
                                                        <label class="fs-5 fw-semibold mb-2">Date
                                                            Reviewed</label>
                                                        <!--end::Label-->
                                                        <!--end::Input-->
                                                        <input type="date" class="form-control form-control-solid"

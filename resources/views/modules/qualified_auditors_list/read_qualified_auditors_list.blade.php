                ...
                <div class="card">
                    ...
                    <div class="card-body p-lg-17">
                        ...
                        <div style="text-align: right" class="position-relative align-right mb-17">
                            ...
                            <a href="{{ url('/') }}/email_qualified_auditors_list/{{ $qal->id }}"
                        ...
                        <div class="d-flex flex-column flex-lg-row mb-17">
                            ...
                            <div class="flex-lg-row-fluid me-0 me-lg-20">
                                ...
                                @endif
                                <!--begin::Form-->
                                <form action="{{route('update_qualified_auditors_list')}}"
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <select name="auditor_status" id="auditor_status" data-control="select2"
                                                ...
                                                @foreach($auditor_statusArr as $auditor_status)
                                                    <option {{$qal->auditor_status == $auditor_status ? 'selected' : ''}}
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--end::Input-->
                                            <select name="qualification_basis_1" id="qualification_basis_1" data-control="select2"
                                                    data-placeholder="Select a position..."
                                                    class="form-select form-select-solid">
                                                @foreach($qualification_basisArr as $qualification_basis)
                                                    <option {{$qal->qualification_basis_1 == $qualification_basis ? 'selected' : ''}}
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--end::Input-->
                                            <select name="qualification_basis_2" id="qualification_basis_2" data-control="select2"
                                                    data-placeholder="Select a position..."
                                                    class="form-select form-select-solid">
                                                @foreach($qualification_basisArr as $qualification_basis)
                                                    <option {{$qal->qualification_basis_2 == $qualification_basis ? 'selected' : ''}}
                                                        value="{{$qualification_basis}}">{{$qualification_basis}}</option>
                                                @endforeach
                                            </select>
                                            <!--end::Input-->
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--end::Input-->
                                            <select name="qualification_basis_3" id="qualification_basis_3" data-control="select2"
                                                    data-placeholder="Select a position..."
                                                    class="form-select form-select-solid">
                                                @foreach($qualification_basisArr as $qualification_basis)
                                                    <option {{$qal->qualification_basis_3 == $qualification_basis ? 'selected' : ''}}
                                                        value="{{$qualification_basis}}">{{$qualification_basis}}</option>
                                                @endforeach
                                            </select>
                                            <!--end::Input-->
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <input type="text" name="web_link_1"
                                                   class="form-control form-control-solid" value="{{$qal->web_link_1}}" readonly>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <input type="text" name="web_link_2"
                                                   class="form-control form-control-solid" value="{{$qal->web_link_2}}" readonly>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>

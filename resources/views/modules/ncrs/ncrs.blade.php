                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-module-table-filter="search"
                                       class="form-control form-control-solid w-250px ps-14" placeholder="Search NCRs">
                            </div>
                            <!--end::Search-->
                            <div class="me-3"></div>
                            ...
                            <select id="ncr_status" name="ncr_status" data-control="select2"
                                    data-placeholder="Filter By Status..."
                                    class="form-select form-select-solid me-3">
                                <option value="" disabled {{ empty($ncrStatus) ? 'selected' : '' }}></option>
                                <option value="Open" {{ $ncrStatus === 'Open' ? 'selected' : '' }}>Open</option>
                                <option value="Closed" {{ $ncrStatus === 'Closed' ? 'selected' : '' }}>Closed</option>
                            </select>
                        ...
                        <div class="card-toolbar">
                            ...
                            <!--begin::Export-->
                                <a href="{{route('export_ncrs')}}" class="btn btn-light-primary me-3">
                            ...
                            @if(auth()->user()->can('create_ncrs'))
                                <!--begin::Add user-->
                                    <a href="{{route('create_ncrs')}}" class="btn btn-primary">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_module_table">
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">NCR #</th>
                                        <th class="min-w-125px">Date of Issue</th>
                                        <th class="min-w-125px">Description of Nonconformance</th>
                                        <th class="min-w-125px">Assigned To</th>
                                        <th class="min-w-125px">Target Date</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div
                                                    ...
                                                    data-kt-menu="true">
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('read_ncrs'))
                                                        <div class="menu-item px-3">
                                                            <a href="read_ncrs/{{$ncr->id}}"
                                                ...
                                                <!--end::Menu item-->
                                                    ...
                                                    @if(auth()->user()->can('edit_ncrs'))
                                                        <div class="menu-item px-3">
                                                            <a href="edit_ncrs/{{$ncr->id}}"
                                                               class="menu-link px-3">Edit</a>
                                                        </div>
                                                    @endif
                                                <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('delete_ncrs'))
                                                        <div class="menu-item px-3">
                                                            <a href="delete_ncrs/{{$ncr->id}}"

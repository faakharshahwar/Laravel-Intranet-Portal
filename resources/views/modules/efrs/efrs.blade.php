...
@section('pageTitle')
    EFRs Environmental Feedback Records
@endsection
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                @if(auth()->user()->can('read_efr'))

                                    <!--begin::Export-->
                                    <a href="{{route('export_efr')}}" class="btn btn-light-primary me-3">
                                ...
                                @if(auth()->user()->can('create_efr'))
                                    <!--begin::Add user-->
                                    <a href="{{route('create_efr')}}" class="btn btn-primary">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_module_table">
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">Interested Party (IP)</th>
                                                ...
                                                <div
                                                    ...
                                                    @if(auth()->user()->can('read_efr'))
                                                        <div class="menu-item px-3">
                                                            <a href="read_efr/{{$efr->id}}"
                                                               class="menu-link px-3">View</a>
                                                        </div>
                                                    @endif
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('edit_efr'))
                                                        <div class="menu-item px-3">
                                                            <a href="edit_efr/{{$efr->id}}"
                                                               class="menu-link px-3">Edit</a>
                                                        </div>
                                                    @endif
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('delete_efr'))
                                                        <div class="menu-item px-3">
                                                            <a href="delete_efr/{{$efr->id}}"
    ...
    <div class="modal fade" id="kt_modal_upload" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" action="{{route('import_efr')}}" method="POST"

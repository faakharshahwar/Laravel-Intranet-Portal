@extends('layouts.app')
@section('pageTitle')
    Add EFRs Environmental Feedback Records
@endsection
@section('content')
    <!--begin::Content-->
                    ...
                    <div class="card-body p-lg-17">
                        ...
                        <div class="d-flex flex-column flex-lg-row mb-17">
                            ...
                            <div class="flex-lg-row-fluid me-0 me-lg-20">
                                ...
                                @endif
                                <!--begin::Form-->
                                <form action="{{route('store_efr')}}" enctype="multipart/form-data"
                                    ...
                                    <div class="d-flex flex-column mb-5 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-solid" placeholder=""
                                               ...
                                               value="{{old('ip_contact_telephone')}}"/>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="d-flex flex-column mb-8">
                                        ...
                                        <textarea class="form-control form-control-solid" rows="4" name="action_taken"
                                                  placeholder="">{{old('action_taken')}}</textarea>
                                    </div>
                                    <!--end::Input group-->

                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-module-table-filter="search"
                                       class="form-control form-control-solid w-250px ps-14" placeholder="Search RARs">
                            </div>
                            <!--end::Search-->
                            <div class="me-3"></div>
                        ...
                        <div class="card-toolbar">
                            ...
                            <!--begin::Export-->
                                <a href="{{route('export_rars')}}" class="btn btn-light-primary me-3">
                            ...
                            @if(auth()->user()->can('create_rars'))
                                <!--begin::Add user-->
                                    <a href="{{route('create_rars')}}" class="btn btn-primary">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_module_table">
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">RAR #</th>
                                        <th class="min-w-125px">Date Identified</th>
                                        <th class="min-w-125px">Department</th>
                                        <th class="min-w-125px">Risk Type</th>
                                        <th class="min-w-125px">Risk Title</th>
                                        <th class="min-w-125px">Risk Source</th>
                                        <th class="min-w-125px">Risk Category</th>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div
                                                    ...
                                                    data-kt-menu="true">
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('read_rars'))
                                                        <div class="menu-item px-3">
                                                            <a href="read_rars/{{$rar->id}}"
                                                               class="menu-link px-3">View</a>
                                                        </div>
                                                    @endif
                                                <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('edit_rars'))
                                                        <div class="menu-item px-3">
                                                            <a href="edit_rars/{{$rar->id}}"
                                                               class="menu-link px-3">Edit</a>
                                                        </div>
                                                    @endif
                                                <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('delete_rars'))
                                                        <div class="menu-item px-3">
                                                            <a href="delete_rars/{{$rar->id}}"

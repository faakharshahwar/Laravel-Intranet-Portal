@extends('layouts.app')
@section('pageTitle')
    Add EDRs Emergency Drill Records
@endsection
@section('content')
    <!--begin::Content-->
                    ...
                    <div class="card-body p-lg-17">
                        ...
                        <div class="d-flex flex-column flex-lg-row mb-17">
                            ...
                            <div class="flex-lg-row-fluid me-0 me-lg-20">
                                ...
                                @endif
                                <!--begin::Form-->
                                <form action="{{route('store_edrs')}}" enctype="multipart/form-data"
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid"
                                                   ...
                                                   name="edr_id" value="{{old('edr_id')}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <input type="datetime-local" class="form-control form-control-solid" placeholder=""
                                                   name="date_and_time_drill" value="{{ old('date_and_time_drill') }}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <select name="type_of_emergency_simulated" data-control="select2"
                                                ...
                                                @foreach($type_of_emergency_simulatedArr as $type_of_emergency_simulated)
                                                    <option value="{{$type_of_emergency_simulated}}">{{$type_of_emergency_simulated}}</option>
                                                @endforeach
                                            </select>
                                            <!--end::Input-->
                                        </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="person_conducting_the_drill" value="{{ old('person_conducting_the_drill') }}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <select name="notification_used" data-control="select2"
                                                ...
                                                @foreach($notification_usedArr as $notification_used)
                                                    <option value="{{$notification_used}}">{{$notification_used}}</option>
                                                @endforeach
                                            </select>
                                            <!--end::Input-->
                                        </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <textarea class="form-control form-control-solid"
                                                      ...
                                                      rows="5">{{ old('staff_on_duty') }}</textarea>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <input type="file" class="form-control form-control-solid" placeholder=""
                                                   name="attachment_staff_participating" value="{{ old('attachment_staff_participating') }}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="number_evacuated" value="{{ old('number_evacuated') }}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <textarea class="form-control form-control-solid"
                                                      ...
                                                      rows="5">{{ old('weather_conditions') }}</textarea>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="time_required" value="{{ old('time_required') }}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <textarea class="form-control form-control-solid"
                                                      ...
                                                      rows="5">{{ old('problems_encountered') }}</textarea>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <textarea class="form-control form-control-solid"
                                                      ...
                                                      rows="5">{{ old('photo_1_description') }}</textarea>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <textarea class="form-control form-control-solid"
                                                      ...
                                                      rows="5">{{ old('photo_2_description') }}</textarea>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>

                ...
                <div class="card">
                    ...
                    <div class="card-body p-lg-17">
                        <div style="float: left" class="position-relative mb-17">
                            <h1>View External Document</h1>
                        </div>
                        <div style="text-align: right" class="position-relative align-right mb-17">
                            <a href="javascript:void(0);"
                               onclick="openPopup('{{ url('/') }}/print_external_document/{{ $external_documents->id }}')"
                               class="btn btn-secondary"><i class="bi bi-printer fs-4 me-2"></i> Print</a>

                            <a href="{{ url('/') }}/email_external_document/{{ $external_documents->id }}" class="btn btn-secondary"><i
                                ...
                                <form action="{{route('update_external_document')}}" enctype="multipart/form-data"
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="site" value="{{$external_documents->site}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="doc_id" value="{{$external_documents->doc_id}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <!--end::Input-->
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="document_type" value="{{$external_documents->document_type}}"
                                                   readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <!--end::Input-->
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="title" value="{{$external_documents->title}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="d-flex flex-column mb-5 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-solid" placeholder=""
                                               name="effective_date"
                                               value="{{format_date($external_documents->effective_date)}}" readonly/>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="d-flex flex-column mb-5">
                                        ...
                                        <input type="text" class="form-control form-control-solid" placeholder=""
                                               ...
                                               value="{{format_date($external_documents->verification_date)}}" readonly/>
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="d-flex flex-column mb-5">
                                        ...
                                        <textarea class="form-control form-control-solid" rows="4"
                                                  ...
                                                  placeholder=""
                                                  readonly>{{$external_documents->verification_method}}</textarea>
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="d-flex flex-column mb-5 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <select name="verified_by" id="verified_by" data-control="select2"
                                    ...
                                    <div class="d-flex flex-column mb-5 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-solid" placeholder=""
                                               ...
                                               value="{{format_date($external_documents->next_verification_due_date)}}" readonly/>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="d-flex flex-column mb-5">
                                        ...
                                        <textarea class="form-control form-control-solid" rows="4"
                                                  ...
                                                  placeholder=""
                                                  readonly>{{$external_documents->primary_location_held}}</textarea>
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    ...
                                    <div class="d-flex flex-column mb-8">
                                        ...
                                        <textarea class="form-control form-control-solid" rows="4" name="comments"
                                                  placeholder="" readonly>{{$external_documents->comments}}</textarea>
                                    </div>
                                    <!--end::Input group-->
...
@section('scripts')
    <script>
        jQuery(document).ready(function ($) {
            var $select2_1 = $('#verified_by').select2();

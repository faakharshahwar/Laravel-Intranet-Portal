                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-module-table-filter="search"
                                       ...
                                       placeholder="Search External Document">
                            </div>
                            <!--end::Search-->
                            <div class="me-3"></div>
                        ...
                        <div class="card-toolbar">
                            ...
                            @if(auth()->user()->can('create_external_document'))
                                <!--begin::Add record-->
                            ...
                            @if(auth()->user()->can('read_external_document'))

                                <!--begin::Export-->
                                    <a href="{{route('export_external_document')}}" class="btn btn-light-primary me-3">
                            ...
                            @if(auth()->user()->can('create_external_document'))
                                <!--begin::Add user-->
                                    <a href="{{route('create_external_document')}}" class="btn btn-primary">
                                        ...
                                        <!--end::Svg Icon-->Add External Document
                                    </a>
                                    <!--end::Add user-->
                                @endif
                            </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_module_table">
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">Title/DOC ID</th>
                                        <th class="min-w-125px">Document Type</th>
                                        <th class="min-w-125px">Effective Date</th>
                                        <th class="min-w-125px">Next Verification Due Date</th>
                                        <th class="min-w-125px">Attachment (If Any)</th>
                                    ...
                                    @foreach($external_documents as $external_document)
                                        <!--begin::Table row-->
                                        <tr>
                                            <td>{{$external_document->id}}</td>
                                            <td>{{$external_document->doc_id}}</td>
                                            <td>{{$external_document->document_type}}</td>
                                            <td>{{format_date($external_document->effective_date)}}</td>
                                            <td>{{format_date($external_document->next_verification_due_date)}}</td>
                                            <td>
                                                <a target="_blank"
                                                   href="{{asset('uploads/external_documents')}}/{{$external_document->attachment}}">{{$external_document->attachment}}</a>
                                            </td>
                                                ...
                                                <div
                                                    ...
                                                    @if(auth()->user()->can('read_external_document'))
                                                        <div class="menu-item px-3">
                                                            <a href="read_external_document/{{$external_document->id}}"
                                                               class="menu-link px-3">View</a>
                                                        </div>
                                                    @endif
                                                <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('edit_external_document'))
                                                        <div class="menu-item px-3">
                                                            <a href="edit_external_document/{{$external_document->id}}"
                                                               class="menu-link px-3">Edit</a>
                                                        </div>
                                                    @endif
                                                <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('delete_external_document'))
                                                        <div class="menu-item px-3">
                                                            <a href="delete_external_document/{{$external_document->id}}"
    ...
    <div class="modal fade" id="kt_modal_upload" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" action="{{route('import_external_document')}}" method="POST"

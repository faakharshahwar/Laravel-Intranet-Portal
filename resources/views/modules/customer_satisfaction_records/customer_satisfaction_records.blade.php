                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-module-table-filter="search"
                                       class="form-control form-control-solid w-250px ps-14" placeholder="Search CSRs">
                            </div>
                            <!--end::Search-->
                            <div class="me-3"></div>
                        ...
                        <div class="card-toolbar">
                            <!--begin::Toolbar-->
                            <div class="d-flex justify-content-end" data-kt-csr-table-toolbar="base">

                            @if(auth()->user()->can('create_customer_feedback_records'))
                                <!--begin::Add record-->
                            ...
                            <!--begin::Export-->
                                <a href="{{route('export_customer_satisfaction_records')}}"
                            ...
                            @if(auth()->user()->can('create_customer_feedback_records'))
                                <!--begin::Add user-->
                                    <a href="{{route('create_customer_satisfaction_records')}}" class="btn btn-primary">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_module_table">
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">Date Data Collected</th>
                                        <th class="min-w-125px">Customer Company Name</th>
                                        <th class="min-w-125px">Customer Service and Assistance</th>
                                        <th class="min-w-125px">On Time Shipment</th>
                                        <th class="min-w-125px">Our Performance vs. Expectations</th>
                                        <th class="min-w-125px">Quality of Product/Service</th>
                                        <th class="min-w-125px">Average - All Applicable Ratings</th>
                                    ...
                                    @foreach($csrs as $csr)
                                        ...
                                        <tr>
                                            <td>{{$csr->ID}}</td>
                                            <td>{{$csr->csr_id}}</td>
                                            <td>{{format_date($csr->date_data_collected)}}</td>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div
                                                    ...
                                                    data-kt-menu="true">
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('read_customer_feedback_records'))
                                                        <div class="menu-item px-3">
                                                            <a href="read_customer_satisfaction_records/{{$csr->id}}"
                                                               class="menu-link px-3">View</a>
                                                        </div>
                                                    @endif
                                                <!--begin::Menu item-->
                                                    @if(auth()->user()->can('edit_customer_feedback_records'))
                                                        <div class="menu-item px-3">
                                                            <a href="edit_customer_satisfaction_records/{{$csr->id}}"
                                                               class="menu-link px-3">Edit</a>
                                                        </div>
                                                    @endif
                                                <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('delete_customer_feedback_records'))
                                                        <div class="menu-item px-3">
                                                            <a href="delete_customer_satisfaction_records/{{$csr->id}}"
    ...
    <div class="modal fade" id="kt_modal_upload" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" action="{{route('import_customer_satisfaction_records')}}" method="POST"

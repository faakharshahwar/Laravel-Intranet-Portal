@extends('layouts.app')
@section('pageTitle')
    Email CSRs Customer Satisfaction Records
@endsection
@section('content')
    <!--begin::Content-->
                ...
                <div class="card">
                    ...
                    <div class="card-body p-lg-17">
                        ...
                        <div class="d-flex flex-column flex-lg-row mb-17">
                            ...
                            @endif
                            <!--begin::Form-->
                                <form action="{{route('send_email_customer_satisfaction_records')}}"
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="date" class="form-control form-control-solid" placeholder=""
                                                   name="date_data_collected" value="{{$csr->date_data_collected}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->

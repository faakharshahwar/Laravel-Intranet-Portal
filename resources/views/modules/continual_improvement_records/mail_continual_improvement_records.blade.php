@extends('layouts.app')
@section('pageTitle')
    Mail Continual Improvement Records
@endsection
@section('content')
    <!--begin::Content-->
                ...
                <div class="card">
                    ...
                    <div class="card-body p-lg-17">
                        ...
                        <div class="d-flex flex-column flex-lg-row mb-17">
                            ...
                            @endif
                            <!--begin::Form-->
                                <form action="{{route('send_email_continual_improvement_records')}}"
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="date" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{$cir->date_originated}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--end::Col-->
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="date" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{$cir->responsible_mgr_approval_date}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--end::Col-->
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="date" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{$cir->target_completion_date}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--end::Col-->
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="date" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{$cir->date_action_was_completed}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--end::Col-->
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="date" class="form-control form-control-solid" placeholder=""
                                                   name="closure_date"
                                                   value="{{$cir->closure_date}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--end::Col-->

                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-module-table-filter="search"
                                       class="form-control form-control-solid w-250px ps-14" placeholder="Search CIRs">
                            </div>
                            <!--end::Search-->
                            <div class="me-3"></div>
                        ...
                        <div class="card-toolbar">
                            ...
                            @if(auth()->user()->can('create_continual_improvement_records'))
                                <!--begin::Add record-->
                            ...
                            <!--begin::Export-->
                                <a href="{{route('export_continual_improvement_records')}}" class="btn btn-light-primary me-3">
                            ...
                            @if(auth()->user()->can('create_customer_feedback_records'))
                                <!--begin::Add user-->
                                    <a href="{{route('create_continual_improvement_records')}}" class="btn btn-primary">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_module_table">
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">CIR #</th>
                                        <th class="min-w-125px">Improvement Opportunity</th>
                                    ...
                                    @foreach($continual_improvement_records as $cir)
                                        <!--begin::Table row-->
                                        <tr>
                                            <td>{{$cir->id}}</td>
                                            <td>{{$cir->cir_id}}</td>
                                            <td>{{$cir->improvement_opportunity}}</td>
                                            <td>{{$cir->originator}}</td>
                                            <td>{{format_date($cir->date_originated)}}</td>
                                            <td>{{$cir->assigned_to}}</td>
                                            <td>{{format_date($cir->target_completion_date)}}</td>
                                            <!--begin::Action=-->
                                            <td class="text-end">
                                                ...
                                                <div
                                                    ...
                                                    data-kt-menu="true">
                                                    @if(auth()->user()->can('read_continual_improvement_records'))
                                                        <div class="menu-item px-3">
                                                            <a href="read_continual_improvement_records/{{$cir->id}}"
                                                               class="menu-link px-3">View</a>
                                                        </div>
                                                    @endif
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('edit_continual_improvement_records'))
                                                        <div class="menu-item px-3">
                                                ...
                                                <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('delete_continual_improvement_records'))
                                                        <div class="menu-item px-3">
                                                            <a href="delete_continual_improvement_records/{{$cir->id}}"
                                                               class="menu-link px-3"
                                                               data-kt-users-table-filter="delete_row" onclick="return confirm('Are you sure to delete the record?')">Delete</a>
                                                        </div>
                                                @endif
                                                <!--end::Menu item-->
                                                </div>
    ...
    <div class="modal fade" id="kt_modal_upload" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" action="{{route('import_continual_improvement_records')}}" method="POST"

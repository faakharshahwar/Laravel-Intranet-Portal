...
<table>
    ...
    <tr>
        ...
        <td>{{ $cir->cir_concise_description }}</td>
    </tr>
    ...
    <tr>
        <th>Department</th>
        <td>{{ $cir->department }}</td>
    </tr>

    <tr>
        <th>Responsible Manager</th>
        <td>{{ $cir->responsible_manager }}</td>
    </tr>

    <tr>
        <th>Responsible Mgr Approval Date</th>
        <td>{{ $cir->responsible_mgr_approval_date }}</td>
    </tr>

    <tr>
        <th>Action To Be Taken</th>
        <td>{{ $cir->action_to_be_taken }}</td>
    </tr>

    <tr>
        <th>File Attachment 1 (If Any)</th>
        <td>{{ $cir->file_attachment_1 }}</td>
    </tr>

    <tr>
        <th>File Attachment 2 (If Any)</th>
        <td>{{ $cir->file_attachment_2 }}</td>
    </tr>
    ...
    <tr>
        ...
        <td>{{ $cir->action_that_was_taken }}</td>
    </tr>

    <tr>
        <th>Action Completed By</th>
        <td>{{ $cir->action_completed_by }}</td>
    </tr>

    <tr>
        <th>Date Action Was Completed</th>
        <td>{{ $cir->date_action_was_completed }}</td>
    </tr>

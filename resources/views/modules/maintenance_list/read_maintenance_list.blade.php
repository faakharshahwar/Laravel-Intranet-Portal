                ...
                <div class="card">
                    ...
                    <div class="card-body p-lg-17">
                        ...
                        <div style="text-align: right" class="position-relative align-right mb-17">
                            <a href="javascript:void(0);"
                               onclick="openPopup('{{ url('/') }}/print_maintenance_list/{{$maintenance_list->id}}')"
                               class="btn btn-secondary"><i class="bi bi-printer fs-4 me-2"></i>Print</a>

                            <a href="{{ url('/') }}/email_maintenance_list/{{ $maintenance_list->id }}"
                    ...
                    <div class="card-body p-lg-17">
                        ...
                        <div class="d-flex flex-column flex-lg-row mb-17">
                            ...
                            @endif
                            <!--begin::Form-->
                                <form action="{{route('update_maintenance_list')}}"
                                      enctype="multipart/form-data"
                                      class="form mb-15" method="post">
                                    @csrf
                                    <input type="hidden" name="id" value="{{$maintenance_list->id}}">
                                    <!--begin::Input group-->
                                    <div class="row mb-5">
                                        <!--begin::Col-->
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="equipment_id"
                                                   value="{{$maintenance_list->equipment_id}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="site"
                                                   value="{{$maintenance_list->site}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="serial_num"
                                                   value="{{$maintenance_list->serial_num}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <textarea class="form-control form-control-solid"
                                                      ...
                                                      rows="5" readonly>{{$maintenance_list->equipment_description}}</textarea>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="manufacturer"
                                                   value="{{$maintenance_list->manufacturer}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="model"
                                                   value="{{$maintenance_list->model}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="d-flex flex-column mb-5 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-solid" placeholder=""
                                               name="location"
                                               value="{{$maintenance_list->location}}" readonly/>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="frequency"
                                                   value="{{$maintenance_list->frequency}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{format_date($maintenance_list->last_maintenance_performed)}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder="N/A"
                                                   ...
                                                   value="{{format_date($maintenance_list->next_maintenance_performed)}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder="N/A"
                                                   name="maintenance_by"
                                                   value="{{$maintenance_list->maintenance_by}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <textarea class="form-control form-control-solid" name="comments"
                                                      id="comments" cols="30"
                                                      rows="5" readonly>{{$maintenance_list->comments}}</textarea>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder="N/A"
                                                   ...
                                                   value="{{$maintenance_list->equipment_status}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder="N/A"
                                                   ...
                                                   value="{{$maintenance_list->action_required}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <a href="{{asset('uploads/maintenance_list')}}/{{$maintenance_list->attachment}}"
                                               target="_blank">{{$maintenance_list->attachment}}</a>
                                            <!--end::Input-->
                                        </div>
                                    </div>
                                    <!--end::Input group-->

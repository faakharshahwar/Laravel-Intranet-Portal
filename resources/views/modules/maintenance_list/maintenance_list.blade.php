                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-module-table-filter="search"
                                       ...
                                       placeholder="Search Maintenance List">
                            </div>
                            <!--end::Search-->
                            <div class="me-3"></div>
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                @if(auth()->user()->can('create_maintenance_list'))
                                    <!--begin::Add record-->
                                ...
                                <!--begin::Export-->
                                <a href="{{route('export_maintenance_list')}}" class="btn btn-light-primary me-3">
                                ...
                                @if(auth()->user()->can('create_maintenance_list'))
                                    <!--begin::Add user-->
                                    <a href="{{route('create_maintenance_list')}}" class="btn btn-primary">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_module_table">
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">Equipment ID</th>
                                        <th class="min-w-125px">Serial # (If Any)</th>
                                        <th class="min-w-125px">Equipment Description</th>
                                        <th class="min-w-125px">Manufacturer</th>
                                        <th class="min-w-125px">Model (If Applicable)</th>
                                        <th class="min-w-125px">Last Prev. Maintenance Performed</th>
                                        <th class="min-w-125px">Next Preventive Maintenance Due</th>
                                        <th class="min-w-125px">Action Required</th>
                                    ...
                                    @foreach($maintenance_lists as $maintenance_list)
                                        <!--begin::Table row-->
                                        <tr>
                                            <td>{{$maintenance_list->id}}</td>
                                            ...
                                            <td>{{format_date($maintenance_list->last_maintenance_performed)}}</td>
                                            <td>{{format_date($maintenance_list->next_maintenance_performed)}}</td>
                                            <td>{{$maintenance_list->action_required}}</td>
                                            <td>
                                                <a href="{{asset('uploads/maintenance_list')}}/{{$maintenance_list->attachment}}"
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div
                                                    ...
                                                    data-kt-menu="true">
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('edit_maintenance_list'))
                                                        <div class="menu-item px-3">
                                                            <a href="read_maintenance_list/{{$maintenance_list->id}}"
                                                    ...
                                                    @if(auth()->user()->can('edit_maintenance_list'))
                                                        <div class="menu-item px-3">
                                                            <a href="edit_maintenance_list/{{$maintenance_list->id}}"
                                                               class="menu-link px-3">Edit</a>
                                                        </div>
                                                    @endif
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('delete_maintenance_list'))
                                                        <div class="menu-item px-3">
                                                            <a href="delete_maintenance_list/{{$maintenance_list->id}}"
    ...
    <div class="modal fade" id="kt_modal_upload" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" action="{{route('import_maintenance_list')}}" method="POST"

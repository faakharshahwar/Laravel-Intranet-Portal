                                ...
                                <form action="{{route('update_maintenance_list')}}"
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="equipment_id"
                                                   value="{{$maintenance_list->equipment_id}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <select name="site" data-control="select2"
                                                ...
                                                @foreach($siteArr as $site)
                                                    <option
                                                        {{$maintenance_list->site == $site ? 'selected' : ''}} value="{{$site}}">{{$site}}</option>
                                                @endforeach
                                            </select>
                                            <!--end::Input-->
                                        </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="serial_num"
                                                   value="{{$maintenance_list->serial_num}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <textarea class="form-control form-control-solid"
                                                      ...
                                                      rows="5">{{$maintenance_list->equipment_description}}</textarea>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="manufacturer"
                                                   value="{{$maintenance_list->manufacturer}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                    ...
                                    <div class="d-flex flex-column mb-5 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-solid" placeholder=""
                                               name="location"
                                               value="{{$maintenance_list->location}}"/>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <select name="frequency" data-control="select2"
                                                ...
                                                @foreach($frequencyArr as $frequency)
                                                    <option
                                                        {{$maintenance_list->frequency == $frequency ? 'selected' : ''}} value="{{$frequency}}">{{$frequency}}</option>
                                                @endforeach
                                            </select>
                                            <!--end::Input-->
                                        </div>
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="date" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{$maintenance_list->last_maintenance_performed}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <input type="date" class="form-control form-control-solid" placeholder="N/A"
                                                   ...
                                                   value="{{$maintenance_list->next_maintenance_performed}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--end::Input-->
                                            <select name="maintenance_by" data-control="select2"
                                                    data-placeholder="Select a position..."
                                                    class="form-select form-select-solid">
                                                @foreach($maintenance_byArr as $maintenance_by)
                                                    <option
                                                        {{$maintenance_list->maintenance_by == $maintenance_by ? 'selected' : ''}} value="{{$maintenance_by}}">{{$maintenance_by}}</option>
                                                @endforeach
                                            </select>
                                            <!--end::Input-->
                                        </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <textarea class="form-control form-control-solid" name="comments"
                                                      id="comments" cols="30"
                                                      rows="5">{{$maintenance_list->comments}}</textarea>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <select name="equipment_status" data-control="select2"
                                                ...
                                                @foreach($equipment_statusArr as $equipment_status)
                                                    <option
                                                        {{$maintenance_list->equipment_status == $equipment_status ? 'selected' : ''}} value="{{$equipment_status}}">{{$equipment_status}}</option>
                                                @endforeach
                                            </select>
                                            <!--end::Input-->
                                        </div>
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <select name="action_required" data-control="select2"
                                                    ...
                                                    class="form-select form-select-solid">
                                                <option
                                                    {{$maintenance_list->action_required == 'Critical' ? 'selected' : ''}} value="Critical">
                                                    Critical
                                                </option>
                                                <option
                                                    {{$maintenance_list->action_required == 'Non-Critical' ? 'selected' : ''}} value="Non-Critical">
                                                    Non-Critical
                                                </option>
                                            </select>
                                            <!--end::Input-->
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <input type="hidden" name="old_attachment" value="{{$maintenance_list->attachment}}">
                                            <!--begin::Input-->

                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                @if(auth()->user()->can('create_inspection_report'))
                                    <!--begin::Add record-->
                                ...
                                @if(auth()->user()->can('read_inspection_report'))

                                    <!--begin::Export-->
                                    <a href="{{route('export_inspection_report')}}" class="btn btn-light-primary me-3">
                                ...
                                @if(auth()->user()->can('create_inspection_report'))
                                    <!--begin::Add user-->
                                    <a href="{{route('create_inspection_reports')}}" class="btn btn-primary">
                                        ...
                                        <!--end::Svg Icon-->Add Inspection Reports
                                    </a>
                                    <!--end::Add user-->
                                @endif
                            </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_module_table">
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">Next Due Date</th>
                                        <th class="min-w-125px">Status</th>
                                        <th class="min-w-125px">Attachment 1</th>
                                                ...
                                                <div
                                                    ...
                                                    @if(auth()->user()->can('read_inspection_report'))
                                                        <div class="menu-item px-3">
                                                            <a href="read_inspection_report/{{$inspection_report->id}}"
                                                               class="menu-link px-3">View</a>
                                                        </div>
                                                    @endif
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('edit_inspection_report'))
                                                        <div class="menu-item px-3">
                                                            <a href="edit_inspection_report/{{$inspection_report->id}}"
                                                               class="menu-link px-3">Edit</a>
                                                        </div>
                                                    @endif
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('delete_inspection_report'))
                                                        <div class="menu-item px-3">
                                                            <a href="delete_inspection_report/{{$inspection_report->id}}"
    ...
    <div class="modal fade" id="kt_modal_upload" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" action="{{route('import_inspection_reports')}}" method="POST"

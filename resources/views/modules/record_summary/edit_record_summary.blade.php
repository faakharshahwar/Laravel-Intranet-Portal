                ...
                <div class="card">
                    ...
                    <div class="card-body p-lg-17">
                        ...
                        <div class="d-flex flex-column flex-lg-row mb-17">
                            ...
                            @endif
                            <!--begin::Form-->
                                <form action="{{route('update_record_summary')}}" enctype="multipart/form-data"
                                      class="form mb-15" method="post">
                                @csrf
                                    <input type="hidden" name="id" value="{{$record_summaries->id}}">
                                <!--begin::Input group-->
                                    <div class="row mb-5">
                                        <!--begin::Col-->
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="record_title" value="{{$record_summaries->record_title}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="doc_id" value="{{$record_summaries->doc_id}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <select name="site" data-control="select2"
                                                ...
                                                @foreach($siteArr as $site)
                                                    <option {{$record_summaries->site == $site ? 'selected' : ''}} value="{{$site}}">{{$site}}</option>
                                                @endforeach
                                            </select>
                                            <!--end::Input-->
                                        </div>
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <select name="location" data-control="select2"
                                                ...
                                                @foreach($record_summary_locationArr as $location)
                                                    <option {{$record_summaries->location == $location ? 'selected' : ''}} value="{{$location}}">{{$location}}</option>
                                                @endforeach
                                            </select>
                                            <!--end::Input-->
                                        </div>
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <select name="type" data-control="select2"
                                                ...
                                                @foreach($record_summary_typeArr as $type)
                                                    <option {{$record_summaries->type == $type ? 'selected' : ''}} value="{{$type}}">{{$type}}</option>
                                                @endforeach
                                            </select>
                                            <!--end::Input-->
                                        </div>
                                    ...
                                    <div class="d-flex flex-column mb-5 fv-row">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <select name="file_manual_title" data-control="select2"
                                                data-placeholder="Select a type..."
                                                class="form-select form-select-solid">
                                                @foreach($record_summary_fileArr as $file)
                                                    <option {{$record_summaries->file_manual_title == $file ? 'selected' : ''}} value="{{$file}}">{{$file}}</option>
                                                @endforeach
                                        </select>
                                        <!--end::Input-->
                                    </div>
                                    ...
                                    <div class="d-flex flex-column mb-5">
                                        ...
                                        <select name="maintained_by" data-control="select2"
                                                data-placeholder="Select a type..."
                                                class="form-select form-select-solid">
                                            @foreach($record_summary_maintained_byArr as $maintained_by)
                                                <option {{$record_summaries->maintained_by == $maintained_by ? 'selected' : ''}} value="{{$maintained_by}}">{{$maintained_by}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="d-flex flex-column mb-5">
                                        ...
                                        <select name="minimum_retention" data-control="select2"
                                                data-placeholder="Select a type..."
                                                class="form-select form-select-solid">
                                            @foreach($record_summary_minimum_retention_byArr as $minimum_retention)
                                                <option {{$record_summaries->minimum_retention == $minimum_retention ? 'selected' : ''}} value="{{$minimum_retention}}">{{$minimum_retention}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="d-flex flex-column mb-5 fv-row">
                                        ...
                                        <select name="record_status" data-control="select2"
                                            ...
                                            @foreach($record_summary_record_status_byArr as $record_status)
                                                <option {{$record_summaries->record_status == $record_status ? 'selected' : ''}} value="{{$record_status}}">{{$record_status}}</option>
                                            @endforeach
                                        </select>
                                        <!--end::Input-->
                                    </div>
                                    ...
                                    <div class="d-flex flex-column mb-5 fv-row">
                                        ...
                                        <textarea class="form-control form-control-solid" rows="4"
                                                  name="comments"
                                                  placeholder="">{{$record_summaries->comments}}</textarea>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->

                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-module-table-filter="search"
                                       ...
                                       placeholder="Search Record Summary">
                            </div>
                            <!--end::Search-->
                            <div class="me-3"></div>
                        ...
                        <div class="card-toolbar">
                            ...
                            @if(auth()->user()->can('create_record_summary'))
                                <!--begin::Add record-->
                            ...
                            @if(auth()->user()->can('read_record_summary'))

                                <!--begin::Export-->
                                    <a href="{{route('export_record_summary')}}" class="btn btn-light-primary me-3">
                            ...
                            @if(auth()->user()->can('create_record_summary'))
                                <!--begin::Add user-->
                                    <a href="{{route('create_record_summary')}}" class="btn btn-primary">
                                        ...
                                        <!--end::Svg Icon-->Add Record Summary
                                    </a>
                                    <!--end::Add user-->
                                @endif
                            </div>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_module_table">
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">Record Title</th>
                                        <th class="min-w-125px">DOC ID</th>
                                        <th class="min-w-125px">Site</th>
                                        <th class="min-w-125px">Location</th>
                                        <th class="min-w-125px">Record Status</th>
                                    ...
                                    @foreach($record_summaries as $record_summary)
                                        <!--begin::Table row-->
                                        <tr>
                                            <td>{{$record_summary->id}}</td>
                                            <td>{{$record_summary->record_title}}</td>
                                            <td>{{$record_summary->doc_id}}</td>
                                            <td>{{$record_summary->site}}</td>
                                            <td>{{$record_summary->location}}</td>
                                            <td>{{$record_summary->record_status}}</td>
                                            <!--begin::Action=-->
                                            <td class="text-end">
                                                ...
                                                <div
                                                    ...
                                                    @if(auth()->user()->can('read_record_summary'))
                                                        <div class="menu-item px-3">
                                                            <a href="read_record_summary/{{$record_summary->id}}"
                                                               class="menu-link px-3">View</a>
                                                        </div>
                                                    @endif
                                                <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('edit_record_summary'))
                                                        <div class="menu-item px-3">
                                                            <a href="edit_record_summary/{{$record_summary->id}}"
                                                               class="menu-link px-3">Edit</a>
                                                        </div>
                                                    @endif
                                                <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('delete_record_summary'))
                                                        <div class="menu-item px-3">
                                                            <a href="delete_record_summary/{{$record_summary->id}}"
    ...
    <div class="modal fade" id="kt_modal_upload" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" action="{{route('import_record_summary')}}" method="POST"

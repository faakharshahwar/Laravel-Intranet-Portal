@extends('layouts.app')
@section('pageTitle')
    Edit MOCRs Management of Change Record
@endsection
@section('content')
    <!--begin::Content-->
                            ...
                            <div class="flex-lg-row-fluid me-0 me-lg-20">
                                ...
                                <form action="{{route('update_mocrs')}}"
                                            ...
                                            <div id="kt_accordion_2_item_1" class="fs-6 collapse show ps-10"
                                                ...
                                                <div class="row mt-10 mb-10">
                                                    ...
                                                    <div class="col-md-6 fv-row">
                                                        ...
                                                        <!--end::Label-->
                                                        <!--begin::Input-->
                                                        <select name="change_requested_by" data-control="select2"
                                                ...
                                                <div class="row mt-10 mb-10">
                                                    ...
                                                    <div class="col-md-12 fv-row">
                                                        ...
                                                        <textarea class="form-control form-control-solid" name="proposed_qms_change"
                                                                  ...
                                                                  rows="2">{{$mocr->proposed_qms_change}}</textarea>
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                ...
                                                <div class="row mt-10 mb-10">
                                                    ...
                                                    <div class="col-md-12 fv-row">
                                                        ...
                                                        <textarea class="form-control form-control-solid" name="purpose_of_change"
                                                                  ...
                                                                  rows="2">{{$mocr->purpose_of_change}}</textarea>
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                ...
                                                <div class="row mt-10 mb-10">
                                                    ...
                                                    <div class="col-md-12 fv-row">
                                                        ...
                                                        <textarea class="form-control form-control-solid" name="potential_consequence_of_change"
                                                                  ...
                                                                  rows="2">{{$mocr->potential_consequence_of_change}}</textarea>
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                ...
                                                <div class="row mt-10 mb-10">
                                                    ...
                                                    <div class="col-md-12 fv-row">
                                                        ...
                                                        <textarea class="form-control form-control-solid" name="impact_on_integrity_of_qms"
                                                                  ...
                                                                  rows="2">{{$mocr->impact_on_integrity_of_qms}}</textarea>
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                ...
                                                <div class="row mt-10 mb-10">
                                                    ...
                                                    <div class="col-md-12 fv-row">
                                                        ...
                                                        <textarea class="form-control form-control-solid" name="availability_of_resources"
                                                                  ...
                                                                  rows="2">{{$mocr->availability_of_resources}}</textarea>
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                ...
                                                <div class="row mt-10 mb-10">
                                                    ...
                                                    <div class="col-md-12 fv-row">
                                                        ...
                                                        <textarea class="form-control form-control-solid" name="allocation_or_reallocation"
                                                                  ...
                                                                  rows="2">{{$mocr->allocation_or_reallocation}}</textarea>
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                ...
                                                <div class="row mt-10 mb-10">
                                                    ...
                                                    <div class="col-md-12 fv-row">
                                                        ...
                                                        <textarea class="form-control form-control-solid" name="additional_considerations"
                                                                  ...
                                                                  rows="2">{{$mocr->additional_considerations}}</textarea>
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                            ...
                                            <div id="kt_accordion_4_item_1" class="fs-6 collapse show ps-10"
                                                ...
                                                <div class="row mt-10 mb-10">
                                                    ...
                                                    <div class="col-md-6 fv-row">
                                                        ...
                                                        <!--end::Label-->
                                                        <!--begin::Input-->
                                                        <select name="change_authorized_by" data-control="select2"
                                                                data-placeholder="Select a originator..."
                                                                class="form-select form-select-solid">
                                                            @foreach($users as $user)
                                    ...
                                    <button type="submit" class="btn btn-primary" id="kt_careers_submit_button">
                                        ...
                                        <span class="indicator-label">Update MOCR</span>
                                        <!--end::Indicator label-->

...
@section('pageTitle')
    MOCRs Management of Change Record
@endsection
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                @if(auth()->user()->can('read_mocr'))

                                    <!--begin::Export-->
                                    <a href="{{route('export_mocr')}}" class="btn btn-light-primary me-3">
                                    ...
                                    <!--end::Export-->
                                @endif
                                @if(auth()->user()->can('create_mocrs'))
                                    <!--begin::Add user-->
                                    <a href="{{route('create_mocrs')}}" class="btn btn-primary">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_module_table">
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">MOCR #</th>
                                        <th class="min-w-125px">Change Requested By</th>
                                        <th class="min-w-125px">Date Requested</th>
                                        <th class="min-w-125px">Change Authorized By</th>
                                        <th class="min-w-125px">Date Authorized</th>
                                        <th class="min-w-125px">Purpose of Change</th>
                                                ...
                                                <div
                                                    ...
                                                    @if(auth()->user()->can('read_mocr'))
                                                        <div class="menu-item px-3">
                                                            <a href="read_mocr/{{$mocr->id}}"
                                                               class="menu-link px-3">View</a>
                                                        </div>
                                                    @endif
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('edit_mocr'))
                                                        <div class="menu-item px-3">
                                                            <a href="edit_mocr/{{$mocr->id}}"
                                                               class="menu-link px-3">Edit</a>
                                                        </div>
                                                    @endif
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('delete_mocr'))
                                                        <div class="menu-item px-3">
                                                            <a href="delete_mocr/{{$mocr->id}}"
    ...
    <div class="modal fade" id="kt_modal_upload" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" action="{{route('import_mocr')}}" method="POST"

@extends('layouts.app')
@section('pageTitle')
    Add MOCRs Management of Change Record
@endsection
@section('content')
    <!--begin::Content-->
                            ...
                            <div class="flex-lg-row-fluid me-0 me-lg-20">
                                ...
                                <form action="{{route('store_mocrs')}}"
                                                ...
                                                <div class="row mt-10 mb-10">
                                                    ...
                                                    <div class="col-md-12 fv-row">
                                                        ...
                                                        <textarea class="form-control form-control-solid" name="proposed_qms_change"
                                                                  ...
                                                                  rows="2">{{old('proposed_qms_change')}}</textarea>
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                ...
                                                <div class="row mt-10 mb-10">
                                                    ...
                                                    <div class="col-md-12 fv-row">
                                                        ...
                                                        <textarea class="form-control form-control-solid" name="purpose_of_change"
                                                                  ...
                                                                  rows="2">{{old('purpose_of_change')}}</textarea>
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                ...
                                                <div class="row mt-10 mb-10">
                                                    ...
                                                    <div class="col-md-12 fv-row">
                                                        ...
                                                        <textarea class="form-control form-control-solid" name="potential_consequence_of_change"
                                                                  ...
                                                                  rows="2">{{old('potential_consequence_of_change')}}</textarea>
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                ...
                                                <div class="row mt-10 mb-10">
                                                    ...
                                                    <div class="col-md-12 fv-row">
                                                        ...
                                                        <textarea class="form-control form-control-solid" name="impact_on_integrity_of_qms"
                                                                  ...
                                                                  rows="2">{{old('impact_on_integrity_of_qms')}}</textarea>
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                ...
                                                <div class="row mt-10 mb-10">
                                                    ...
                                                    <div class="col-md-12 fv-row">
                                                        ...
                                                        <textarea class="form-control form-control-solid" name="availability_of_resources"
                                                                  ...
                                                                  rows="2">{{old('availability_of_resources')}}</textarea>
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                ...
                                                <div class="row mt-10 mb-10">
                                                    ...
                                                    <div class="col-md-12 fv-row">
                                                        ...
                                                        <textarea class="form-control form-control-solid" name="allocation_or_reallocation"
                                                                  ...
                                                                  rows="2">{{old('allocation_or_reallocation')}}</textarea>
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                                ...
                                                <div class="row mt-10 mb-10">
                                                    ...
                                                    <div class="col-md-12 fv-row">
                                                        ...
                                                        <textarea class="form-control form-control-solid" name="additional_considerations"
                                                                  ...
                                                                  rows="2">{{old('additional_considerations')}}</textarea>
                                                        <!--end::Input-->
                                                    </div>
                                                    <!--end::Col-->
                                                </div>
                                    ...
                                    <button type="submit" class="btn btn-primary" id="kt_careers_submit_button">
                                        ...
                                        <span class="indicator-label">Submit MOCR</span>
                                        <!--end::Indicator label-->

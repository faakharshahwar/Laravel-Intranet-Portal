...
<table>
    ...
    <tr>
        ...
        <td><a target="_blank"
               href="/uploads/dcrs/{{$dcr->document_for_approval}}">{{$dcr->document_for_approval}}</a></td>
    </tr>
    <tr>
        <th>Effective Date</th>
        <td>{{ $dcr->effective_date }}</td>
    </tr>
    <tr>
        <th>Approver 1 </th>
        <td>{{ $approver_1 }}</td>
    ...
    <tr>
        ...
        <td>{{ $dcr->approval_review_comments}}</td>
    </tr>
    <tr>
        <th>Date Approved</th>
        <td>{{ $dcr->date_approved}}</td>
    </tr>
    <tr>
        <th>Training Assessed</th>
        <td>{{ $dcr->training_assessed}}</td>
    </tr>
    </tbody>
</table>
</body>

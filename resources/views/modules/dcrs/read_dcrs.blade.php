                                ...
                                <form action="{{route('update_dcrs')}}"
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <!--end::Input-->
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="effective_date" value="{{format_date($dcr->effective_date)}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <!--end::Input-->
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="date_approved" value="{{format_date($dcr->date_approved)}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <!--end::Input-->
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="training_assessed" value="{{format_date($dcr->training_assessed)}}"
                                                   readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->

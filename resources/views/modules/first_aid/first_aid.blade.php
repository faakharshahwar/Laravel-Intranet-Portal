                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                @if(auth()->user()->can('create_first_aid'))
                                    <!--begin::Add record-->
                                ...
                                @if(auth()->user()->can('read_first_aid'))

                                    <!--begin::Export-->
                                    <a href="{{route('export_first_aid')}}" class="btn btn-light-primary me-3">
                                ...
                                @if(auth()->user()->can('create_first_aid'))
                                    <!--begin::Add user-->
                                    <a href="{{route('create_first_aid')}}" class="btn btn-primary">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_module_table">
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">Production Date</th>
                                    ...
                                    @foreach($first_aids as $first_aid)
                                        <!--begin::Table row-->
                                        <tr>
                                            <td>{{$first_aid->id}}</td>
                                            <td>{{$first_aid->site}}</td>
                                            <td>{{$first_aid->item_name}}</td>
                                                ...
                                                <div
                                                    ...
                                                    @if(auth()->user()->can('read_first_aid'))
                                                        <div class="menu-item px-3">
                                                            <a href="read_first_aid/{{$first_aid->id}}"
                                                               class="menu-link px-3">View</a>
                                                        </div>
                                                    @endif
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('edit_first_aid'))
                                                        <div class="menu-item px-3">
                                                            <a href="edit_first_aid/{{$first_aid->id}}"
                                                               class="menu-link px-3">Edit</a>
                                                        </div>
                                                    @endif
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    @if(auth()->user()->can('delete_first_aid'))
                                                        <div class="menu-item px-3">
                                                            <a href="delete_first_aid/{{$first_aid->id}}"
    ...
    <div class="modal fade" id="kt_modal_upload" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" action="{{route('import_first_aid')}}" method="POST"

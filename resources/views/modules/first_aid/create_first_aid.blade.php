                    ...
                    <div class="card-body p-lg-17">
                        ...
                        <div class="d-flex flex-column flex-lg-row mb-17">
                            ...
                            <div class="flex-lg-row-fluid me-0 me-lg-20">
                                ...
                                @endif
                                <!--begin::Form-->
                                <form action="{{route('store_first_aid')}}" enctype="multipart/form-data"
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <input type="date" class="form-control form-control-solid" placeholder=""
                                                   name="production_date" value="{{old('production_date')}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <input type="number" class="form-control form-control-solid" placeholder=""
                                                   name="required_quantity" value="{{old('required_quantity')}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 col-md-12-cust fv-row">
                                            ...
                                            <!--begin::Input-->
                                            <input type="number" class="form-control form-control-solid" placeholder=""
                                                   name="available_quantity" value="{{old('available_quantity')}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>

...
@section('pageTitle')
    CPARs Corrective Action Records
@endsection
                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-module-table-filter="search"
                                       class="form-control form-control-solid w-250px ps-14" placeholder="Search CPARs">
                            </div>
                            <!--end::Search-->
                            <div class="me-3"></div>
                        ...
                        <div class="card-toolbar">
                            ...
                            <!--begin::Export-->
                                <a href="{{route('export_cpars')}}" class="btn btn-light-primary me-3">
                            ...
                            @if(auth()->user()->can('create_customer_feedback_records'))
                                <!--begin::Add user-->
                                    <a href="{{route('create_cpars')}}" class="btn btn-primary">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_module_table">
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">CPAR #</th>
                                        <th class="min-w-125px">Date of Issue</th>
                                        <th class="min-w-125px">Description of Issue</th>
    ...
    <div class="modal fade" id="kt_modal_upload" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                <!--begin::Form-->
                <form class="form" action="{{route('import_cpars')}}" method="POST"

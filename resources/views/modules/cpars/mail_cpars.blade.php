                ...
                <div class="card">
                    ...
                    <div class="card-body p-lg-17">
                        ...
                        <div class="d-flex flex-column flex-lg-row mb-17">
                            ...
                            @endif
                            <!--begin::Form-->
                                <form action="{{route('send_email_cpars')}}"
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <!--begin::Input-->
                                            <a target="_blank"
                                               href="{{asset('uploads/CPARs')}}/{{$cpar->attachment_1}}">{{$cpar->attachment_1}}</a>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <a target="_blank"
                                               href="{{asset('uploads/CPARs')}}/{{$cpar->attachment_2}}">{{$cpar->attachment_2}}</a>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>

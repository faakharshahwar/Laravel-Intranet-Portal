                    ...
                    <div class="card-body p-lg-17">
                        ...
                        <div style="text-align: right" class="position-relative align-right mb-17">
                            <a href="javascript:void(0);"
                               onclick="openPopup('{{ url('/') }}/print_cpars/{{$cpar->id}}')"
                               class="btn btn-secondary"><i class="bi bi-printer fs-4 me-2"></i> Print</a>

                            <a href="{{ url('/') }}/email_cpars/{{ $cpar->id }}"
                                ...
                                <!--begin::Input group-->
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="date_of_issue"
                                                   value="{{format_date($cpar->date_of_issue)}}" readonly />
                                            <!--end::Input-->
                                        </div>
                                        <!--begin::Col-->
                                        <div class="col-md-6 fv-row">
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <textarea class="form-control form-control-solid" name="reason_if_other"
                                                      ...
                                                      rows="2" readonly >{{$cpar->reason_if_other}}</textarea>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="d-flex flex-column mb-5 fv-row">
                                        ...
                                        <textarea class="form-control form-control-solid" name="description_of_issue"
                                                  ...
                                                  rows="5" readonly>{{$cpar->description_of_issue}}</textarea>
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="originator"
                                                   value="{{$cpar->originator}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{format_date($cpar->date_originated)}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="results_area"
                                                   value="{{$cpar->results_area}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{$cpar->responsible_manager}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{format_date($cpar->manager_acceptance_date)}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <textarea class="form-control form-control-solid" name="root_cause"
                                                      ...
                                                      rows="2" readonly>{{$cpar->root_cause}}</textarea>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <a target="_blank" href="{{asset('uploads/CPARs')}}/{{$cpar->attachment_1}}">{{$cpar->attachment_1}}</a>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <a target="_blank" href="{{asset('uploads/CPARs')}}/{{$cpar->attachment_2}}">{{$cpar->attachment_2}}</a>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <textarea class="form-control form-control-solid" name="action_to_be_taken"
                                                      ...
                                                      rows="5" readonly>{{$cpar->action_to_be_taken}}</textarea>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="assigned_to"
                                                   value="{{$cpar->assigned_to}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{format_date($cpar->target_completion_date)}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{format_date($cpar->date_action_was_completed)}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <textarea class="form-control form-control-solid"
                                                      ...
                                                      rows="5" readonly>{{$cpar->effectiveness_evaluated}}</textarea>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{$cpar->action_taken_effective}}" readonly/>
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <textarea class="form-control form-control-solid"
                                                      ...
                                                      rows="2" readonly>{{$cpar->what_action_was_taken}}</textarea>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{$cpar->action_taken_by}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <textarea class="form-control form-control-solid"
                                                      ...
                                                      rows="5" readonly>{{$cpar->documents_revised}}</textarea>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{format_date($cpar->date_documents_revised)}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   name="closure_date"
                                                   value="{{format_date($cpar->closure_date)}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>

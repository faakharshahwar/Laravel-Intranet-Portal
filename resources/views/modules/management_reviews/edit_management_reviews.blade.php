                            ...
                            <!--begin::Form-->
                                ...
                                <!--begin::Input group-->
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="date" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{$management_reviews->date_of_management_review}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <select name="site" data-control="select2"
                                                ...
                                                @foreach($siteArr as $site)
                                                    <option {{$management_reviews->site == $site ? 'selected' : ''}} value="{{$site}}">{{$site}}</option>
                                                @endforeach
                                            </select>
                                            <!--end::Input-->
                                        </div>
                                    ...
                                    <div class="d-flex flex-column mb-5 fv-row">
                                        ...
                                        <select name="status" data-control="select2"
                                            ...
                                            @foreach($statusArr as $status)
                                                <option {{$management_reviews->status == $status ? 'selected' : ''}} value="{{$status}}">{{$status}}</option>
                                            @endforeach
                                        </select>
                                        <!--end::Input-->
                                    </div>
                                    ...
                                    <div class="d-flex flex-column mb-8">
                                        ...
                                        <input type="hidden" name="old_agenda" value="{{$management_reviews->agenda}}">
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--end::Input-->
                                            <input type="hidden" name="old_minutes_attachment" value="{{$management_reviews->minutes_attachment}}">
                                            <input type="file" class="form-control form-control-solid" placeholder=""
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--end::Input-->
                                            <input type="hidden" name="old_attachment_1" value="{{$management_reviews->attachment_1}}">
                                            <input type="file" class="form-control form-control-solid" placeholder=""
                                                   name="attachment_1"/>
                                            <!--end::Input-->
                                        </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--end::Input-->
                                            <input type="hidden" name="old_attachment_2" value="{{$management_reviews->attachment_2}}">
                                            <input type="file" class="form-control form-control-solid" placeholder=""
                                                   name="attachment_2"/>
                                            <!--end::Input-->
                                        </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--end::Input-->
                                            <input type="hidden" name="old_attachment_3" value="{{$management_reviews->attachment_3}}">
                                            <input type="file" class="form-control form-control-solid" placeholder=""
                                                   name="attachment_3"/>
                                            <!--end::Input-->
                                        </div>
                                    ...
                                    <div class="row mb-5">
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <textarea class="form-control form-control-solid" name="comments"
                                                      id="comments" cols="30"
                                                      rows="5">{{$management_reviews->comments}}</textarea>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--end::Col-->

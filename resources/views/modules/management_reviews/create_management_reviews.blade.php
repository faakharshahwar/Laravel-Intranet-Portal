                ...
                <div class="card">
                    ...
                    <div class="card-body p-lg-17">
                        ...
                        <div class="d-flex flex-column flex-lg-row mb-17">
                            ...
                            @endif
                            <!--begin::Form-->
                                <form action="{{route('store_management_reviews')}}"
                                ...
                                <!--begin::Input group-->
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            <!--begin::Label-->
                                            <label class="required fs-5 fw-semibold mb-2">Date of Management Review</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="date" class="form-control form-control-solid" placeholder=""
                                                   name="date_of_management_review"
                                                   value="{{old('date_of_management_review')}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->

                ...
                <div class="card">
                    ...
                    <div class="card-body p-lg-17">
                        ...
                        <div class="d-flex flex-column flex-lg-row mb-17">
                            ...
                            @endif
                            <!--begin::Form-->
                                <form action="{{route('send_email_management_reviews')}}"
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="date" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{$management_reviews->date_of_management_review}}" readonly/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->

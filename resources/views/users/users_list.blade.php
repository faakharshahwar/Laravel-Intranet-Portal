        ...
        <div class="container-xxl" id="kt_content_container">
            ...
            <div class="card">
                                            ...
                                            <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                                ...
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <div class="d-flex fv-row">
                                                        ...
                                                        {{--                                                               class="form-check-input me-3"/> In Active--}}
                                                    </div>
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                ...
                <div class="card-body py-4">
                    <!--begin::Table-->
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_user_module_table">
                        <!--begin::Table head-->
                        <thead>
                        <!--begin::Table row-->
                            ...
                            <tr>
                                ...
                                <td class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column">
                                        <a href="../../demo4/dist/apps/user-management/users/view.html"
                                        ...
                                        @if(auth()->user()->can('delete_user'))
                                            @foreach($user->roles as $r)
                                                @if($r->name == "Super Admin")
                                                    <div class="menu-item px-3">
                                                        <a disabled href="" class="menu-link px-3"
                                                           data-kt-users-table-filter="delete_row"
                                                           onclick="return confirm('<?php echo "Cannot delete super admin. Change the role first." ?>')">Delete</a>
                                                    </div>
                                                @else
                                                    <div class="menu-item px-3">
                                                        <a href="delete_user/{{$user->id}}" class="menu-link px-3"
                                                           data-kt-users-table-filter="delete_row"
...
@section('scripts')
    ...
    <script>
        $(document).ready(function () {
            datatable = $("#kt_user_module_table").DataTable({
                "order": [[0, "asc"]],  // Keep sorting by the first column (ID)
            });

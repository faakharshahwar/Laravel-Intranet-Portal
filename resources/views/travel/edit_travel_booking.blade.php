                        ...
                        <div class="d-flex flex-column flex-lg-row mb-17">
                            ...
                            <div class="flex-lg-row-fluid me-0 me-lg-20">
                                ...
                                <form action="{{route('update_travel_booking')}}" enctype="multipart/form-data"
                                    ...
                                    @if($tb->management_approval_status == 1 || $tb->management_approval_status == 2)
                                        <div class="alert bg-light-primary">
                                            <!--begin::Icon-->
                                            <i class="bi bi-pencil-square fs-4 me-2"></i>
                                            <!--end::Icon-->
                                            You cannot edit primary details after the booking <strong>approved</strong>
                                            or
                                    ...
                                    @if($tb->management_approval_status == 0 || $tb->management_approval_status == "")
                                        <div class="row mb-8">
                                            <div class="col-md-6 fv-row">
                                                <a href="{{ route('approval_travel_booking', ['id' => $tb->id, 'status' => 1]) }}"
                                                   class="btn btn-sm btn-success">
                                                    <i class="bi bi-check-square fs-4 me-2"></i> Approve Request
                                                </a>
                                                <a href="{{ route('approval_travel_booking', ['id' => $tb->id, 'status' => 2]) }}"
                                                   class="btn btn-sm btn-danger">
                                                    <i class="bi bi-x-square fs-4 me-2"></i> Decline Request
                                                </a>
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 col-md-12-cust fv-row">
                                            ...
                                            <input type="date" class="form-control form-control-solid" placeholder=""
                                                   name="departure_date" value="{{$tb->departure_date}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                        <div class="col-md-6 col-md-12-cust fv-row">
                                            ...
                                            <!--end::Input-->
                                            <input type="date" class="form-control form-control-solid" placeholder=""
                                                   name="return_date" value="{{$tb->return_date}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 col-md-12-cust fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{$tb->booking_reference_pnr}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                        <!--begin::Col-->
                                    ...
                                    <div class="row mb-5">
                                        <div class="col-md-6 fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{$tb->estimated_travel_cost}}"/>
                                        </div>
                                        <!--begin::Col-->
                                        <div class="col-md-6 col-md-12-cust fv-row">
                                            <!--end::Label-->
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="col-md-6 col-md-12-cust fv-row">
                                            ...
                                            <input type="text" class="form-control form-control-solid" placeholder=""
                                                   ...
                                                   value="{{$tb->travel_insurance_provider}}"/>
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row mb-5">
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <textarea class="form-control form-control-solid" rows="4"
                                                      name="safety_notes"
                                                      placeholder="">{{$tb->safety_notes}}</textarea>
                                        </div>
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="row mb-5">
                                        <div class="col-md-12 fv-row">
                                            ...
                                            <textarea class="form-control form-control-solid" rows="4"
                                                      ...
                                                      placeholder="">{{$tb->additional_comments}}</textarea>
                                        </div>
                                    </div>
                                    <!--end::Input group-->
                                                ...
                                                @foreach ($travel_booking_attachments as $travel_booking_attachment)
                                                    <div data-repeater-item-db>
                                                        <div class="form-group row mt-5">
                                                            ...
                                                            <div class="col-md-3 delete_attachment">
                                                                <a href="javascript:;" data-repeater-delete
                                                                   class="btn btn-sm btn-light-danger mt-5 mt-md-9"
                                                                   data-item-id="{{$travel_booking_attachment->id}}">
                                                                    Delete
                                                                </a>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="row mb-5">
                                        <div class="col-md-12 fv-row">
                                            <label class="fs-5 fw-semibold mb-2">Change Remarks (If Any)</label>
                                            <textarea class="form-control form-control-solid" rows="3"
                                                      name="remarks"
                                                      placeholder="Add remarks for this update (optional)">{{ old('remarks') }}</textarea>
                                        </div>
                                    </div>
